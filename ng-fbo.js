...
(function (angular) {
  angular.module('ngFbo', []).config(['$compileProvider', function ($compileProvider) {
    $compileProvider.directive('fboNotifier', ['$parse', function ($parse) {
      var Mode = {
          SHALLOW: 'shallow',
          DEEP: 'deep',
    ...
    $compileProvider.directive('fboParse', ['$parse', function ($parse) {
      return {
        require: '?^fboNotifier',
    ...
    $compileProvider.directive('fboBindHtml', ['$parse', '$compile', function ($parse, $compile) {
      return {
        require: '?^fboNotifier',
        compile: function compile(element, attrs) {
    ...
    $compileProvider.directive('fboClass', ['$parse', function ($parse) {
      return {
        require: '?^fboNotifier',
        compile: function compile(element, attrs) {
    ...
    $compileProvider.directive('fboIf', ['$parse', '$compile', function ($parse, $compile) {
      return {
        require: '?^fboNotifier',
    ...
    $compileProvider.directive('fboSwitch', ['$parse', '$compile', function ($parse, $compile) {
      return {
        require: '^?fboNotifier',
    ...
    $compileProvider.directive('fboShow', ['$parse', function ($parse) {
      return {
        require: '^?fboNotifier',
        compile: function (element, attrs) {
    ...
    $compileProvider.directive('fboHide', ['$parse', function ($parse) {
      return {
        require: '^?fboNotifier',
        compile: function (element, attrs) {
